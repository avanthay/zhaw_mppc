...
/**
 * Das Wort ist 2Byte lang (16 bits), das erste bit wird für das Vorzeichen verwendet
 * Ein Wort kann nur die Zeichen 0 oder 1 annehmen
 * 
 * @author dave
 * @version 1.0
 */
public class Word {
	...
	/**
	 * 
	 * @param index Index des gewünschten char im gesamten Wort (16bit)
	...
	/**
	 * 
	 * @return Das MSb (Vorzeichenbit). Dieser ist mit 1 negativ und mit 0 positiv
	 */
	public char getMSb(){
		return MSb;
	}
	...
	/**
	 * 
	 * @param MSb Das MSb (Vorzeichenbit). Dieser kann mit 1 negativ und mit 0 positiv gesetzt werden
	 */
	...
	/**
	 * 
	 * @param amount Den 15bit langen Wert des Wortes, ohne MSb (Vorzeichenbit)
	 */
	...
	/**
	 * 
	 * @param string Das gesamte Wort (16bit, inklusive MSb)
	 */
